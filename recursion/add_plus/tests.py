...
class TestAddPlus(unittest.TestCase):
    ...
    def test_size_3(self):
        """Function returns correct list for array size of 3. (5p)"""
        size = 3
    ...
    def test_size_6(self):
        """Function returns correct list for array size of 6. (5p)"""
        size = 6
        orig_array = create_array(size)
        correct_array = [['+', '*', '*', '*', '*', '+'], ['*', '+', '*', '*', '+', '*'], ['*', '*', '+', '+', '*', '*'],
        ['*', '*', '+', '+', '*', '*'], ['*', '+', '*', '*', '+', '*'], ['+', '*', '*', '*', '*', '+']]
    ...
    def test_size_7(self):
        """Function returns correct list for array size of 7. (5p)"""
        size = 7
        orig_array = create_array(size)
        correct_array = [['+', '*', '*', '*', '*', '*', '+'], ['*', '+', '*', '*', '*', '+', '*'], ['*', '*', '+', '*', '+', '*', '*'], ['*', '*', '*', '+', '*', '*', '*'],
        ['*', '*', '+', '*', '+', '*', '*'], ['*', '+', '*', '*', '*', '+', '*'], ['+', '*', '*', '*', '*', '*', '+']]
